...
energies_ = (-1)*np.array(all_energies)  # * 1.60218e-19  # decomment to convert from eV to Joules
E_tot_ml_array = (-1) * np.array(E_tot_ml_list)  # * 1.60218e-19  # decomment to Convert predicted energies from eV to Joules
